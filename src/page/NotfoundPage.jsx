...
const NotfoundPage = () => {
  return (
    <div className="h-[100vh] text-black items-center flex justify-center px-5 lg:px-0 ">
      <div className="w-[415px] text-center flex-col items-center justify-center mx-auto gap-[100px]">
        ...
        <div className="flex flex-col gap-6 mt-3">
          ...
          <div>
            <a href={"/"}>
              <button className="bg-textColor text-white font-sans max-w-[146px] w-full h-[48px] rounded-[100px] font-medium text-sm">
                Home Page
              </button>
            </a>
          </div>
