...
import AddRoomSize from "./AddRoomSize";
import AddRoomFeatures from "./AddRoomFeatures";
    ...
    <Sidebar>
      <div className="flex flex-col">
            ...
            <div className="flex flex-col gap-5 items-start">
              ...
              <div className="flex gap-2 md:items-center relative md:flex-row flex-col w-full">
                ...
                <select
                  ...
                  }  rounded-md md:w-[27vw] w-full`}
                >
                  <option value="">Select Bed Type</option>
                  {bedTypeData.map((item) => (
                    <option value={item.bed_type} key={item.id}>
                      {item.bed_type}
                    </option>
                  ))}
                </select>
                ...
                <button
                  onClick={() => setBedTypeModalVisible(!bedTypeModalVisible)}
                  className="bg-textColor px-3 py-3 text-white   rounded flex items-center justify-center"
                >
                  <FaPlus size={14} />
                </button>
              </div>
              <div className="flex gap-2 md:items-center relative md:flex-row flex-col w-full">
                ...
                <button
                  onClick={() => setRoomSizeVisible(!roomSizeVisible)}
                  className="bg-textColor px-3 py-3 text-white   rounded flex items-center justify-center"
                >
                  <FaPlus size={14} />
                </button>
        ...
        <div className="">
          ...
          <div className="flex md:flex-row flex-col items-center py-2 md:gap-5 gap-2 w-full relative">
            {/* Available Features */}
            <div
              className={
      ...
      <AddBedType
        bedTypeModalVisible={bedTypeModalVisible}
        setBedTypeModalVisible={setBedTypeModalVisible}
        fetchBedtype={fetchBedtype}
      />
      <AddRoomSize
        roomSizeVisible={roomSizeVisible}
        setRoomSizeVisible={setRoomSizeVisible}
        fetchRomSize={fetchRomSize}
      />
      <AddRoomFeatures
        featureModalVisible={featureModalVisible}
        setFeatureModalVisible={setFeatureModalVisible}
        fetchFeatureListdata={fetchFeatureListdata}
      />
    </Sidebar>
  );
};
