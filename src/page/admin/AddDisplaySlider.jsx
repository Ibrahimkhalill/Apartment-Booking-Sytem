              ...
              <tbody>
                {data.map((item, index) => (
                  <tr
                    ...
                    key={index}
                    className={`${sliderId === item.id ? "bg-textColor text-white":"bg-white"}  border-b cursor-pointer dark:bg-gray-800 dark:border-gray-700 hover:bg-textColor hover:text-white dark:hover:bg-gray-600`}
                  >
