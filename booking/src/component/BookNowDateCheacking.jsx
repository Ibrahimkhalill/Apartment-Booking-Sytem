...
const BookNowDateCheacking = ({ width }) => {
  ...
  return (
    <>
      <div className="flex flex-col items-center gap-2 relative rounded border w-full h-full bg-white">
        <div className="flex md:flex-row flex-col items-center gap-4 border-b w-full">
          <div
          ...
          <div className="bg-white flex items-center relative  justify-between   w-full px-2 md:px-0">
            <button
              className="flex  items-center justify-between md:w-[18vw]  gap-2 w-full"
              ref={flag1Ref}
              onClick={() => {
            ...
            {guestCardVisible && (
              <div
                ref={dropdown1Ref}
                className={`md:absolute fixed md:top-[70px] md:bottom-auto bottom-0 md:h-auto h-screen pt-1 gap-5 right-0 flex flex-col z-40 xl:w-[22vw] sm:w-[30vw] w-full shadow-custom md:rounded-md md:border-2 border-textColor bg-white pb-3 zoom-in`}
              >
        ...
        <div
          ref={dropdownRef}
          className={`   flex-col py-5 bg-white h-[55vh] overflow-y-auto  w-full  xl:w-auto rounded-t-md md:rounded-md  transition-transform duration-300 flex items-center justify-center`}
        >
          <div
                ...
                {currentMonthDays.map((day) => {
                  ...
                  return (
                    <button
                      ...
                      className={`p-3 px-6 text-center cursor-pointer ${
                        shouldHide
                      ...
                      onMouseEnter={() => !shouldHide && setHoveredDate(day)} // Set hovered date if not hidden
                      onMouseLeave={() => !shouldHide && setHoveredDate(null)} // Reset hovered date on leave if not hidden
                    >
                ...
                {nextMonthDays.map((day) => {
                  ...
                  return (
                    <div
                      ...
                      onMouseEnter={() => !shouldHide && setHoveredDate(day)} // Set hovered date on hover if not hidden
                      onMouseLeave={() => !shouldHide && setHoveredDate(null)} // Reset hovered date on leave if not hidden
                    >
                      {day.date()}
                    </div>
...
export default BookNowDateCheacking;
