...
const Checkout = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.status === 201) {
        ...
        navigate(`/booking/confirmation?${queryString}`);
        setLoaing(false);
      }
    } catch (error) {
  ...
  return (
    <main className="container m-auto 2xl:max-w-[75%] w-full pb-10 px-2 ">
      ...
      <div className="w-full flex md:flex-row flex-col gap-3">
        <div className="md:w-[25%]">
          ...
          <div className="w-full border flex flex-col  mt-4 rounded border-[#b5c5dd]">
            ...
            <div className="px-3 py-2 text-sm flex flex-col gap-2">
              <h1 className="text-black font-bold">Occupancy</h1>
              {data.booking?.room_quantity} room, {data.booking?.adults} adults
            </div>
            <div className="px-3 py-2 text-sm flex flex-col gap-2">
        ...
        <div className="py-2 md:w-[75%]">
          ...
          {paymentVisible ? (
            ...
            <div className="  rounded-md flex flex-col gap-3 my-4">
                ...
                <div className="flex gap-2 md:w-[70%]">
                  <div className="flex flex-col items-start gap-1 ">
                    ...
                    <select
                      id="title"
                      className={
                        "border-slate-400 w-[100px] py-[8px] border outline-none rounded-md text-sm  px-2"
                      }
                ...
                <div className="my-7  flex flex-col gap-7">
                  <div className="flex flex-col items-start gap-1 w-full relative">
                    ...
                    <p className="text-xs text-gray-500">
                      ...
                      Apartment Group. We will also use this email to send your
                      confirmation email.
                    </p>
                  </div>
                  <div className="flex flex-col items-start gap-1 md:w-[59%] w-full relative">
              ...
              <div className="bg-white px-3 py-5 flex flex-col gap-4 border rounded-md relative">
                ...
                <div className="flex flex-col gap-1">
                  <label htmlFor="text-area" className="font-semibold text-sm">
