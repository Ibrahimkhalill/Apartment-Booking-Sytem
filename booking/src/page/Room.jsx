...
const Room = () => {
  ...
  useEffect(() => {
    document.body.style.overflow =
      searchVisible || booknowVisible ? "hidden" : "auto";
    return () => {
      // Cleanup overflow style on modal close
      document.body.style.overflow = "auto";
    };
  }, [searchVisible, booknowVisible]);
    ...
    <div className="flex relative items-center flex-col">
      ...
      {booknowVisible && (
        <>
          ...
          {/* Modal */}
          <div className=" duration-500 ease-in-out transition-transform shadow-custom md:w-[61%] w-full fixed md:h-auto h-screen z-50 md:top-16 top-0 left-1/2 -translate-x-1/2 border bg-white  border-[#795f9e] md:px-6 md:py-5 pl-3 pr-1 md:rounded-lg ">
            ...
            <div className="float-right my-3">
              <button
                ...
                className="bg-textColor py-3 px-10 text-white rounded-full"
              >
                Book
              </button>
            </div>
